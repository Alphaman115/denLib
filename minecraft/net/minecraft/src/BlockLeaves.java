...
public class BlockLeaves extends BlockLeavesBase implements IShearable
{
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            for (LeavesDrop drop : denLibManagers.LeavesDropManager.getDrops()){
                if (par1World.rand.nextInt(drop.getNextInt()) == 0){
                    this.dropBlockAsItem_do(par1World, par2, par3, par4, drop.getDrop().copy());
                }
            }
        }
    }

package denoflionsx.denLib.Mod.Client.Render;
...
import denoflionsx.denLib.Mod.Blocks.BlockFluidRoot;
		...
		else
		{
			...
			if(renderer.renderAllFaces || renderBottom)
			{
				...
				else
				{
					...
					renderer.renderFaceYNeg(block, x, y + d6, z, block.getIcon(1, bMeta));
				}
			}
